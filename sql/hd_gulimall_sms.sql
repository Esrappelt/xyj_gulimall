...
CREATE TABLE `sms_seckill_session` (
  ...
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='秒杀活动场次';

-- ----------------------------
-- Records of sms_seckill_session
-- ----------------------------
INSERT INTO `sms_seckill_session` VALUES ('3', '15:00', '2022-06-26 15:40:00', '2022-06-26 17:08:06', '1', '2022-06-26 15:59:57');
...
CREATE TABLE `sms_seckill_sku_relation` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='秒杀活动商品关联';

-- ----------------------------
-- Records of sms_seckill_sku_relation
-- ----------------------------
INSERT INTO `sms_seckill_sku_relation` VALUES ('1', null, '1', '11', '999', '10', '1', '1');
INSERT INTO `sms_seckill_sku_relation` VALUES ('2', null, '3', '11', '1000', '10', '1', '0');
...
CREATE TABLE `sms_sku_full_reduction` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1536981745503670275 DEFAULT CHARSET=utf8 COMMENT='商品满减信息';

-- ----------------------------
-- Records of sms_sku_full_reduction
-- ----------------------------
INSERT INTO `sms_sku_full_reduction` VALUES ('1536979371976400897', '27', '10000.0000', '50.0000', null);
INSERT INTO `sms_sku_full_reduction` VALUES ('1536980004687155202', '28', '10000.0000', '50.0000', null);
INSERT INTO `sms_sku_full_reduction` VALUES ('1536980234006532098', '29', '10000.0000', '50.0000', null);
INSERT INTO `sms_sku_full_reduction` VALUES ('1536981745503670274', '30', '10000.0000', '50.0000', null);
...
CREATE TABLE `sms_sku_ladder` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1536981745503670274 DEFAULT CHARSET=utf8 COMMENT='商品阶梯价格';

-- ----------------------------
-- Records of sms_sku_ladder
-- ----------------------------
INSERT INTO `sms_sku_ladder` VALUES ('1536979371921874945', '27', '3', '0.98', null, '0');
INSERT INTO `sms_sku_ladder` VALUES ('1536980004649406465', '28', '3', '0.98', null, '0');
INSERT INTO `sms_sku_ladder` VALUES ('1536980233704542211', '29', '3', '0.98', null, '0');
INSERT INTO `sms_sku_ladder` VALUES ('1536981745503670273', '30', '3', '0.98', null, '0');
...
CREATE TABLE `sms_spu_bounds` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1538456664989036546 DEFAULT CHARSET=utf8 COMMENT='商品spu积分设置';

-- ----------------------------
-- Records of sms_spu_bounds
-- ----------------------------
INSERT INTO `sms_spu_bounds` VALUES ('1536979369023610882', '14', '500.0000', '500.0000', null);
INSERT INTO `sms_spu_bounds` VALUES ('1536980001499484162', '15', '500.0000', '500.0000', null);
INSERT INTO `sms_spu_bounds` VALUES ('1536980233704542210', '16', '500.0000', '500.0000', null);
INSERT INTO `sms_spu_bounds` VALUES ('1536981745243623426', '17', '500.0000', '500.0000', null);
INSERT INTO `sms_spu_bounds` VALUES ('1536984806422818817', '18', '500.0000', '300.0000', null);
INSERT INTO `sms_spu_bounds` VALUES ('1537319233602469889', '19', '300.0000', '200.0000', null);
INSERT INTO `sms_spu_bounds` VALUES ('1538402931437473794', '22', '100.0000', '100.0000', null);
INSERT INTO `sms_spu_bounds` VALUES ('1538456664989036545', '23', '100.0000', '100.0000', null);
