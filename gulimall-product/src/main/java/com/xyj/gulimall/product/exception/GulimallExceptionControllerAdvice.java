package com.xyj.gulimall.product.exception;
 ...
 * */
@Slf4j
@RestControllerAdvice(basePackages = "com.xyj.gulimall.product.controller")
public class GulimallExceptionControllerAdvice {
    @ExceptionHandler(value = ConstraintViolationException.class) // 捕获异常 发生异常就来到这里 进行统一处理 返回结果
